...
CAFFEMODEL = "./submodules/models/res10_300x300_ssd_iter_140000.caffemodel"
PROTOTEXTPATH = "./submodules/models/deploy.prototxt.txt"
class Stream:
...
def initSystem():
    global CAFFEMODEL, PROTOTEXTPATH
