...
class FaceDetectionLightRfb:
    def __init__(self):
        ...
        self.net = create_Mb_Tiny_RFB_fd(len(self.class_names), is_test=True, device="cuda:0")
        self.predictor = create_Mb_Tiny_RFB_fd_predictor(self.net, candidate_size=self.candidate_size, device="cuda:0")
